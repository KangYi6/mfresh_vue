<template>
  <div>
    <!--banner（轮播图）-->
    <!-- 关于webpack的打包机制：webpack的打包是静态依赖关系；有依赖就会自动引入 -->
    <!-- src="../assets/images/banner_01.jpg"  webpack分析代码时，就知道img依赖此图片展示，就会打包图片 -->
    <!-- for循环是运行时执行，属于动态分析 -->
...
export default {
  data() {
    return {
      ...
      //轮播图图片
      banners: [
        //require：静态分析的时候，webpack 看到 require 关键词，就知道后方的文件必须引入；
